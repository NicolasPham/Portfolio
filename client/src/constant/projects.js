...
export const projects = [
  {
    ...
    highlightFront: ["Use React to create a beautiful UI/UX design front end social media app", "Creates different components that will be shown in different pages base on the given condition", "Have light mode and dark mode for custom use, triggered by one click on the icon", "Use react-router-dom, react-icon etc to give a full function to the application", "Use Redux as a complex center data storage instead of useContext and Reducer", "Fetching data to show required info user pages base on the given parameter (use Id)", "Apply SASS to professionally manage and well style application"],
    highlightBack: [],
  ...
  },
  {
    ...
    highlightFront: ["Apply useContext to fetching user info from local storage to display on the website", "Use different react libraries such as react-date-range, react-router-dom to give more features", "Apply SASS to manage and  style web site professionally"],
  ...
  },
  {
    ...
    highlightFront:["Like the other complex app using React for creating front end web application", "Since the user info is simple, useContext and Reducer are applied", "SASS and flexbox are used to well styled"],
  ...
  },
  {
    ...
    highlightFront:["Using EJS Engine to render the basic function campsite", "Create boiler plate that apply to different pages"],
  ...
  },
  {
    ...
    highlightFront:["Use Vite framework to create an app conveniently", "Define styled variables for reuse in CSS files", "Use tailwind for immediate and proficient changes in styles"],
    highlightBack: [],
  ...
  },
  {
    ...
    highlightFront:["Apply flexbox to style website", "Use ::before and ::after to create an empty div to background modification", "Gradient colors generation"],
    highlightBack: [],
  ...
  },
  {
    ...
    highlightFront:["Use boostrap to fast create navbar, carousel", "Apply knowledge about position to locate the pictures in desired place"],
    highlightBack: [],
